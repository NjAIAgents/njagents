...
You should see a header with the team, the source modes and **Agent 0.6.7**, then a
...
| --- | --- | --- |
| `operations/bug-triage-agent` | Disposition gate, release correlation, workaround discovery and priority scoring, a bug queue, fix briefs for a fix-bug agent, and an audit log, with a shared rubric and per-team configuration | 0.6.7. Run on recorded fixtures and a live Jira demo in Cowork |
